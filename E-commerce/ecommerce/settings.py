...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "/images/icons8-franchise-50.png",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "/images/icons8-franchise-50.png",

    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": "/images/icons8-franchise-50.png",
    ...
    "order_with_respect_to": ["account", "store"],
...
EMAIL_HOST_USER = 'e.abdalaziz11@gmail.com'                #THE RECIVING EMAIL
EMAIL_HOST_PASSWORD = 'kcgdxtvgfxzyzjqw'          #THE RECIVING EMAIL PASSWORD